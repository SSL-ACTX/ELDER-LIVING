  ...
  <main class="container">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="../../html/categories-page/shower-chairs-and-bath-seats.php">Shower Chairs with Backrest</a></li>
        <li class="breadcrumb-item active" aria-current="page">Adjustable Shower Chair</li>
      </ol>
    </nav>
    ...
    <div class="product-container">
          <article class="product-image-container">
              <img src="../../assets/shower-chair.png" alt="Product Image" class="product-image" style="margin-top: 2rem;">
          </article>
          <article class="product-details-container">
              <p class="category">Shower Chairs with Backrest</p>
                <h1 class="product-name">
                    ADJUSTABLE SHOWER <br>
                    CHAIR
                </h1>
    ...
    <article class="description-content" id="description">
          <p class="description-paragraph">
            ...
            This height-adjustable shower chair is designed for comfort and safety
            during bathing. Made of durable aluminum alloy, it provides stability and support while
            resisting rust and deterioration in humid bathroom environments.
          </p>
          <p class="item-weight">
              Item Weight <span class="weight">: 2.5 kg</span>
          </p>
          <p class="item-dimension">
              Dimensions <span class="centimeter">: Seat height adjustable from 15 to 21 inches, seat width 17 inches</span>
          </p>
    </article>
...
function generateStars(rating) {
    const starValue = Math.min(Math.max(rating, 1), 5);
