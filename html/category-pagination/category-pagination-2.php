...
<head>
  ...
  <link rel="stylesheet" href="../../css/category-pagination/category-pagination-2.css?v=1.0">
  ...
  <main class="container">
    ...
    <div class="navbar-border"></div>
        ...
        <article class="main-category">
          ...
          <div class="main-category-list">
            <a href="../../html/categories-page/adaptive-kitchen-tools.php" class="Adaptive-kitchen-tools">
              ...
              <img src="../../assets/adaptive.png" alt="Adaptive Kitchen Tools" class="category-image" style="width: 120px; margin-bottom: 30px; margin-left: 25px; margin-top: 55px;">
                <h1 class="Adaptive-kitchen-tools-text" style="margin-top: 75px;">
                  Adaptive Kitchen Tools
                </h1>
              </div> 
            </a>
     ...
     <div class="pagination">
          <a href="../../../html/CategoryPage.php"><</a>
          <a href="../html/CategoryPage.php" class="active">1</a>
