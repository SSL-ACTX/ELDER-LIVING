...
<head>
  ...
  <link rel="stylesheet" href="/html/admin-dashboard/css/dashboard-orders.css">
...
<body>
  <main class="main">
    <nav class="sidebar" role="navigation">
        <div class="sidebar-content">
            ...
            <a href="/html/admin-dashboard/html/dashboard-orders.php" class="nav-orders" role="menuitem">
      ...
      <div class="header-flex">
        ...
        <section class="orders-container">
            <header class="orders-header">
              <span class="order-label">Image</span>
  ...
  <script src="../js/fetchOrders.js"></script>
