  ...
  <main class="container">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="../../html/categories-page/personal-care-products.php">Personal Care Products</a></li>
        <li class="breadcrumb-item active" aria-current="page">Moisturizing Body Wash</li>
      </ol>
    </nav>
    ...
    <div class="product-container">
          <article class="product-image-container">
              <img src="../../assets/cetaphil.png" alt="Product Image" class="product-image" style="margin-top: 2rem;">
          </article>
          <article class="product-details-container">
              <p class="category">Personal Care Products</p>
    ...
    <article class="description-content" id="description">
          <p class="description-paragraph">
            <span class="prod-name">
              Gentle, hypoallergenic body wash <span>  
              designed to moisturize and cleanse sensitive skin
              without irritation. Ideal for older adults, this body wash is fragrance-free and enriched with
              Aloe Vera and Vitamin B5, leaving the skin feeling soft, replenished, and hydrated.
          </p>
          <p class="item-weight">
              Item Weight <span class="weight">: 500 ml bottle</span>
          </p>
    </article>
