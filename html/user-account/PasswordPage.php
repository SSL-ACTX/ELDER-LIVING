    ...
    if($user) {
      if(password_verify($old_password, $user['password'])) {
        ...
        if ($update->getModifiedCount() > 0) {
         ...
         echo "<script>alert('Current password are incorrect.');</script>";
      }
    }
  }
}
...
<head>
  ...
  <title>Elder Living | Account Password Page</title>
  <link rel="icon" type="image/png" sizes="32x32" href="../../assets/elder-living-logo.png">
  <link rel="stylesheet" href="../../css/user-account/PasswordPage.css?v=1.0">
  ...
  <main class="container">
    ...
    <section class="account-container">
      ...
      <article class="account-details">
          ...
          <div class="account-section-four">
              <input type="password" name="old-password" id="old-password" placeholder="Current Password" class="account-password">
              <input type="password" name="new-password" id="new-password" placeholder="New Password" class="account-password">
              <input type="password" name="confirm-password" id="confirm-password" placeholder="Confirm Password" class="account-password">
          </div>
          <div class="account-section-five">
