  ...
  <main class="container">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="../../html/categories-page/reachers-and-grabbers.php">Reachers and Grabbers</a></li>
        <li class="breadcrumb-item active" aria-current="page">32-Inch Reacher Grabber Tool</li>
      </ol>
    </nav>
    ...
    <div class="product-container">
          <article class="product-image-container">
              <img src="../../assets/grabber-tool.png" alt="Product Image" class="product-image" style="margin-top: 2rem;">
          </article>
          <article class="product-details-container">
              <p class="category">Reachers and Grabbers</p>
                <h1 class="product-name">
                    32-Inch Reacher <br> Grabber Tool
                </h1>
    ...
    <article class="description-content" id="description">
          <p class="description-paragraph">
            <span class="prod-name">
              Lightweight grabber tool with soft rubber tips for secure gripping,
              perfect for reaching high shelves and retrieving items without bending or stretching.
          </p>
          <p class="item-weight">
              Item Weight <span class="weight">: 0.3 kg</span>
          </p>
          <p class="item-dimension">
              Dimensions <span class="centimeter">: 32 inches long</span>
          </p>
    </article>
