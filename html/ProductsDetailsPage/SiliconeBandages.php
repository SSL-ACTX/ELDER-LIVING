  ...
  <main class="container">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="../../html/categories-page/first-aid-kits.php">First Aid Kits</a></li>
        <li class="breadcrumb-item active" aria-current="page">Silicone Bandages</li>
      </ol>
    </nav>
    ...
    <div class="product-container">
          <article class="product-image-container">
              <img src="../../assets/bandages.png" alt="Product Image" class="product-image" style="margin-top: 3.5rem; margin-right: 10rem;">
          </article>
          <article class="product-details-container">
              <p class="category">First Aid Kits</p>
    ...
    <article class="description-content" id="description">
          <p class="description-paragraph">
            ...
            Design for the Elders: As we aged, our skin has become fragile. Silicone bandages stick well to skin but not the wound and come off easily for daily changes. For adults, it has a large enough surface to cover the wound. Best of all, they do not hurt while removing. No discomfort or secondary damage, no latex
          </p>
          <p class="item-weight">
              Item Dimension <span class="weight">: 4 x 2 x 0.04 inches</span>
          </p>
    </article>
