...
<head>
  ...
  <link rel="stylesheet" href="/html/admin-dashboard/css/dashboard-customers.css">
  ...
  <main class="main">
    <nav class="sidebar" role="navigation">
        <div class="sidebar-content">
            ...
            <a href="/html/admin-dashboard/html/dashboard-customers.php" class="nav-customers" role="menuitem">
      ...
      <section class="customer-section">
        ...
        <header class="header-container">
            <nav class="breadcrumb">
                Dashboard / <span class="breadcrumb-secondary">Orders</span>
            </nav>
        </header>
        ...
        <main class="customer-container">
          <header class="table-header">
            ...
            <span class="header-cell">Phone</span>
            <span class="header-cell">Spent</span>
          </header>
      
          <div role="list" id="customer-list">
...
<script src="../js/fetchCustomers.js">
</script>
