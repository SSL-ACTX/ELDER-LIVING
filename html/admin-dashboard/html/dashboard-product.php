...
<head>
  ...
  <link rel="stylesheet" href="/html/admin-dashboard/css/dashboard-product.css">
        ...
        <section class="product-section">
            ...
            <header class="header-container">
                <nav class="breadcrumb">
                      Dashboard / <span class="breadcrumb-secondary">Products</span>
                </nav>
            </header>
            ...
            <div class="products-container">
                ...
                <!--removed a lot of code - as we moved to dynamic loading of products from db -->
            </div>
...
<script src="../js/fetchProd.js"></script>
