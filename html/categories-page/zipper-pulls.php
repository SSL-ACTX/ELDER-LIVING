...
<head>
  ...
  <link rel="stylesheet" href="../../css/category-page/zipper-pulls.css">
  ...
  <footer class="site-footer">
    <div class="footer-content">
      ...
      <div class="footer-section account-info">
        ...
        <a href="/html/user-account/AccountPage.php" class="account-link">My Account</a>
        <a href="/html/Login.php" class="account-link">Login / Signup</a>
        <a href="/html/CartPage.php" class="account-link">Your Cart</a>
        <a href="/html/user-account/PurchasePage.php" class="account-link">Your Order</a>
        <a href="/html/LandingPage.php" class="account-link">Shop</a>
      </div>
  
      <div class="footer-section quick-links">
        <h2 class="section-title">Quick Links</h2>
        <a href="/html/AboutPage.php" class="quick-link-item">FAQ</a>
        <a href="/html/ContactPage.php" class="quick-link-item">Contact</a>
        <a href="/html/AboutPage.php" class="quick-link-item">About Us</a>
        <a href="/html/LandingPage.php" class="quick-link-item">Home</a>
        <a href="/html/ArticlesPage.php" class="quick-link-item">Articles</a>
      </div>
