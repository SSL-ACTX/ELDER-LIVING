  ...
  <main class="container">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="../../html/categories-page/mobility-aids.php">Mobility Aids</a></li>
        <li class="breadcrumb-item active" aria-current="page">4 Wheel Mobility Scooter</li>
      </ol>
    </nav>
    ...
    <div class="product-container">
          <article class="product-image-container">
              <img src="../../assets/mobility-scooter.png" alt="Product Image" class="product-image" style="margin-top: 2rem;">
          </article>
          <article class="product-details-container">
              <p class="category">Mobility Aids</p>
    ...
    <article class="description-content" id="description">
          <p class="description-paragraph">
            <span class="prod-name">
              4 Wheel Mobility Scooter, Upgrade Electric Power Mobile Wheelchair for Seniors
              Adult with Lights Collapsible and Compact Duty Travel Scooter w/Basket and Extended Battery
          </p>
          <p class="item-weight">
              Item Weight <span class="weight">: 42.5" (L) x 20.4" (W) x 35.4" (H)</span>
          </p>
    </article>
